 ...
 * @author sescalo
 */
public class CalcuCupFrame extends javax.swing.JFrame {

    /**
     * Creates new form CalcuCupFrame
     */
    public CalcuCupFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalcuCupFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalcuCupFrame().setVisible(true);
            }
        });
    }
